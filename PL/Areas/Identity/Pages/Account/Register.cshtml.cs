        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Port = 587,
                        Credentials = new NetworkCredential("e.grijalva.sa@gmail.com", "ihafguxypvudizeg"),
                        EnableSsl = true,
                    ...
                    var mensaje = new MailMessage
                    {
                        ...
                        Body = @"
                                <html>
                                <head>
                                    <title>Confirmación de Mi Cuenta</title>
                                </head>
                                <body style='font-family: Times New Roman', Times, serif; margin: 0; padding: 0; background-color: #f0f0f0;'>
